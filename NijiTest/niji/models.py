...
class Topic(models.Model):
    ...
    # 更改为百度富文本
    content_raw = UEditorField(
        toolbars='full', imagePath='images/', filePath='files/', upload_settings={'imageMaxSize': 1204000}, settings={},
        verbose_name=_("raw content"))

    # content_rendered = models.TextField(default='', blank=True, verbose_name=_("rendered content"))
    content_rendered = UEditorField(toolbars='full', imagePath='images/', filePath='files/',
                                    upload_settings={'imageMaxSize': 1204000}, settings={}, default='', blank=True,
...
class Post(models.Model):
    ...
    # content_raw = models.TextField(verbose_name=_("raw content"))
    content_raw = UEditorField(toolbars='full', imagePath='images/', filePath='files/',
                               upload_settings={'imageMaxSize': 1204000}, settings={}, verbose_name=_("raw content"),
                               null=False,)
    # content_rendered = models.TextField(default='', verbose_name=_("rendered content"))
    content_rendered = UEditorField(toolbars='full', imagePath='images/', filePath='files/',
                                    upload_settings={'imageMaxSize': 1204000}, settings={}, default='',
                                    verbose_name=_("rendered content"))
